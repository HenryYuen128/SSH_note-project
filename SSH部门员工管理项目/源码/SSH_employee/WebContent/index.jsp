...
<h3><s:actionerror/></h3>
	<div class="login_cont">
		<ul class="login">
			...
			<li class="mb_10"><input type="text" name="eusername" class="login_input user_icon"></li>
			<li class="l_tit">密码</li>
			<li class="mb_10"><input type="text" name="epassword" class="login_input user_icon"></li>
